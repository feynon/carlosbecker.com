...
First of all, if you haven't done it yet, read [Getting started with GWT-Bootstrap]({{< ref "/posts/getting-started-with-gwt-bootstrap/index.md" >}}).
...
In this point, we have to setup the `*.gwt.xml` file and our `UIBinder` XML file. You can follow [getting started tutorial]({{< ref "/posts/getting-started-with-gwt-bootstrap/index.md" >}}). to do that in the right way.
...
{{< img caption="" src="e0639978-f394-4e1f-be9c-4371150bd951.png" >}}
...
{{< img caption="" src="b67ca540-e6e9-4f32-828b-7e7a4f45fc67.png" >}}
