...
Some time ago, I [posted here]({{< ref "/posts/modular-persistence/index.md" >}}) about a simple project that I've done in my post-graduation classes. Since I need it in other projects, and also some friends ended up using it in small projects, I decided to evolve it a little bit.
