...
does not bother me much, giving that there is one.
...
was [Prettier][prettier], but, since I wanted to add it to the CI as well,
...
I decided to step back and take another look at the [JSON package docs][docs]
...
([because that's the right thing to do][tws]):
...
[tws]: https://stackoverflow.com/questions/2287967/why-is-it-recommended-to-have-empty-line-in-the-end-of-file
